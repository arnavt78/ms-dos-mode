...
$confirm = Read-Host "Are you sure you want to edit the Registry (required to restart)? (y/N)"
...
$confirmRestart = Read-Host "You MUST restart to return back to 'MS-DOS' mode. Restart now? (y/N)"
